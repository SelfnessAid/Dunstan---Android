package mobidev.com.dunstan.adapters;
...
public class CustomSpinnerAdapter extends ArrayAdapter<String> {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        if(isFirstTime) {
            objects.remove(0);
            objects.add(0, firstElement);
//            objects.get(0). = firstElement;
            isFirstTime = false;
        }
...
//        TextView label = (TextView) row.findViewById(android.R.layout.simple_spinner_item);
